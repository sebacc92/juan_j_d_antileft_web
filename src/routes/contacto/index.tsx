    ...
    <section class="py-16 bg-white min-h-screen">
      <div class="container mx-auto px-4 max-w-2xl">
        ...
        <p class="mb-8 text-gray-700 text-center">
          ¿Tienes dudas, consultas o quieres comunicarte con la Mutual Cultural Círculo Italiano Joven Italia? Completa el formulario y te responderemos a la brevedad.
        </p>
        ...
        <div class="mt-10 text-center text-gray-600">
          <p class="mb-2">Juan Antileft</p>
          <p class="mb-2">Email: <a href="mailto:info@circuloitaliano.org.ar" class="text-green-700 underline">info@juanantileft.com</a></p>
          <p>Teléfono: <a href="tel:+542294420000" class="text-green-700 underline">(011) 6508-7671</a></p>
        </div>
      </div>
    </section>
  );
